        ...
        public class CachedMovieclip extends Sprite {
                ...
                public function buildFromClip(Clip:MovieClip):void {
                        ...
                        for (i = 1; i <= len; ++i) {
								...
								RecursiveNextFrame(child);
                        }
                        
                        gotoAndStop(1);
                }
				
				private function RecursiveNextFrame(dobj:DisplayObject):void 
				{
					...
					if (container)
					{
						...
						{
							RecursiveNextFrame(container.getChildAt(i));
						}
					}
					
					if (dobj is MovieClip)
					{
						(dobj as MovieClip).nextFrame();
					}
				}
